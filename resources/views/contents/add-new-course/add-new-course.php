...
if (Form::validate(['name', 'description', 'department', 'add_new_course'])) {
    Academics::addNewCourse();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="add_new_course" type="submit">Save New Course</button>
    </div>
  </form>
</div>
