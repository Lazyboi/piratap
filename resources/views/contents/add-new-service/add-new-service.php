...
if (Form::validate(['name', 'add_new_service'])) {
    Ticketing::addNewService();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-olive pull-right" name="add_new_service" type="submit">Save New Service</button>
    </div>
  </form>
</div>
