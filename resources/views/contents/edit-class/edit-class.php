...
Academics::validateClass();

if (Form::validate(['subject', 'section', 'professor', 'subject_type', 'days', 'started_at', 'ended_at', 'room', 'edit_class'])) {
    Academics::editClass();
} else {
...
<?php Form::displayMessage(); ?>
      ...
      <div class="form-group <?php Form::displayFieldState('professor', 'state'); ?>">
        ...
        <div class="col-sm-10">
          <select class="form-control" name="professor" required size="10">
            <?php UserManagement::displayUserSelect(Form::getFieldData('professor')); ?>
          </select>
  ...
  <div class="form-group <?php Form::displayFieldState('started_at', 'state'); ?>">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="edit_class" type="submit">Save Class</button>
    </div>
  </form>
</div>
