...
if (Form::validate(['name', 'edit_computer'])) {
    ComputerLaboratory::editComputer();
} else {
    ComputerLaboratory::loadComputerFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-olive pull-right" name="edit_computer" type="submit">Save Computer Changes</button>
    </div>
  </form>
</div>
