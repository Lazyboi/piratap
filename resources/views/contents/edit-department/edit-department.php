...
if (Form::validate(['name', 'acronym', 'edit_department'])) {
    UserManagement::editDepartment();
} else {
    UserManagement::loadDepartmentFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="edit_department" type="submit">Save Changes</button>
    </div>
  </form>
</div>
