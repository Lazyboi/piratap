...
Route::validateTabs(1);

return false;

if (Route::currentData(1) == 'basic-details') {
    if (Form::validate(['name_of_violation_incident', 'summary_of_violation_incident', 'persons_involved', 'reported_at', 'reported_by', 'processed'])) {
...
if (Route::currentData(1) == 'process-details') {
    if (!Form::validate(['name_of_violation_incident', 'summary_of_violation_incident', 'persons_involved', 'reported_at', 'reported_by', 'processed'], true)) {
...
if (Route::currentData(1) == 'review-and-save') {
    if (!Form::validate(['processed'], true)) {
        Route::go(Route::current(), 'basic-details');
    }

    if (Form::getFieldData('processed', true) == 1) {
        if (!Form::validate(['name_of_violation_incident', 'summary_of_violation_incident', 'persons_involved', 'reported_at', 'reported_by'], true)) {
            Route::go(Route::current(), 'basic-details');
        }
    ...
    } elseif (Form::getFieldData('processed', true) == 2) {
        if (!Form::validate(['name_of_violation_incident', 'summary_of_violation_incident', 'persons_involved', 'reported_at', 'reported_by', 'findings', 'action_taken', 'processed_at', 'processed_by'], true)) {
            Route::go(Route::current(), 'process-details');
        }
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    <div class="box-body">
      ...
      <?php if (Route::currentData(1) == 'basic-details'): ?>
      ...
      <?php endif; ?>
      <?php if (Route::currentData(1) == 'process-details'): ?>
      ...
      <?php endif; ?>
      <?php if (Route::currentData(1) == 'review-and-save'): ?>
        <div class="detail">
          <div class="row">
            <div class="col-xs-12">
    ...
    <div class="box-footer">
      ...
      <?php endif; ?>
      <?php if (Route::currentData(1) == 'review-and-save'): ?>
        <button class="btn bg-olive pull-right" name="edit_new_incident_report" type="submit">Save Incident Report Changes</button>
      <?php endif; ?>
    </div>
  </form>
</div>
