...
if (Form::validate(['name', 'response_time', 'color', 'edit_priority'])) {
    Ticketing::editPriority();
} else {
    Ticketing::loadPriorityFieldData();
}
  ...
  <form class="form-horizontal" method="POST">
    <div class="box-body">
      ...
      <div class="form-group <?php Form::displayFieldState('color', 'state'); ?>">
        ...
        <div class="col-sm-10">
          <input autocomplete="off" autofocus class="form-control" id="color" name="color" required type="color" value="<?php Form::loadFieldData('color'); ?>">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-olive pull-right" name="edit_priority" type="submit">Save Priority Changes</button>
    </div>
  </form>
</div>
