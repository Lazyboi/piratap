...
if (Form::validate(['name', 'edit_role'])) {
    UserManagement::editRole();
} else {
    UserManagement::loadRoleFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="edit_role" type="submit">Save Changes</button>
    </div>
  </form>
</div>
