...
if (Form::validate(['name', 'edit_service'])) {
    Ticketing::editService();
} else {
    Ticketing::loadServiceFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-olive pull-right" name="edit_service" type="submit">Save Service Changes</button>
    </div>
  </form>
</div>
