...
if (Form::validate(['name', 'description', 'edit_subject'])) {
    Academics::editSubject();
} else {
    Academics::loadSubjectFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="edit_subject" type="submit">Save Changes</button>
    </div>
  </form>
</div>
