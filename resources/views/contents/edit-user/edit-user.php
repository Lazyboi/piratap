...
if (Form::validate(['username', 'first_name', 'last_name', 'email_addresses', 'departments', 'edit_user'])) {
    UserManagement::editUser();
} else {
    UserManagement::loadUserFieldData();
}
...
<div class="box box-solid">
  ...
  <form class="form-horizontal" method="POST">
    ...
    <div class="box-footer">
      ...
      <button class="btn bg-harvard-red pull-right" name="edit_user" type="submit">Save Changes</button>
    </div>
  </form>
</div>
