...
if (!Permission::can('view-assigned-class')) {
    Route::go('dashboard');
}
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active">
          <div class="tab-toolbox">
            <?php if (Route::currentData() == 'created' && Permission::can('add-new-assigned-class')): ?>
              <a class="btn bg-harvard-red btn-sm" href="<?php Route::loadURL('add-new-assigned-class'); ?>">
                <?php Route::displayIcon('add-new-role'); ?> <span><?php Route::displayName('add-new-assigned-class'); ?>
              </a>
            <?php endif; ?>
          </div>
